...
class CurrencyGetterInterface(CurrencyGetterType('CurrencyGetter', (object,),
                                                 {})):
    """ Abstract class of currency getter
        ...
        For example::
            ...
            from flectra.addons.currency_rate_update \
    ...
    def check_rate_date(self, rate_date, max_delta_days):
        ...
        if days_delta > max_delta_days:
            raise Exception(
                ...
                'Rate not updated in Flectra.' % (rate_date, days_delta,
                                                  max_delta_days)
            )
