...
class RoBnrGetter(CurrencyGetterInterface):
    ...
    supported_currency_array = \
        ["AED", "AUD", "BGN", "BRL", "CAD", "CHF", "CNY",
         "CZK", "DKK", "EGP", "EUR", "GBP", "HUF", "INR", "JPY", "KRW", "MDL",
         "MXN", "NOK", "NZD", "PLN", "RON", "RSD", "RUB", "SEK", "TRY", "UAH",
         "USD", "XAU", "XDR", "ZAR"]
    ...
    def rate_retrieve(self, dom, ns, curr):
        ...
        try:
            res['rate_ref'] = \
                float(dom.xpath(xpath_rate_ref, namespaces=ns)[0])
        except Exception:
            res['rate_ref'] = 1
        return res
